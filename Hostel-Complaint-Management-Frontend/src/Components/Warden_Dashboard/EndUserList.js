...
import "./EndUserList.css";
import { toast } from "react-toastify";

const EndUserList_Dashboard = () => {
  ...
  return (
    <div className="EndUserList_dashboard">
          ...
          {endUsers.map((user) => (
            <tr key={user._id}>
              ...
              <td>
                {editingUserId === user._id ? (
                  <button
                    className="War-EndUserList_save-btn"
                  ...
                  <>
                    <button
                      className="War-EndUserList_edit-btn"
                      onClick={() => startEditing(user._id)}
                    >
                      Edit
                    </button>
                    <button
                      className="War-EndUserList_delete-btn"
                      onClick={() => deleteUser(user._id)}
                    >
                      Delete
                    </button>
                    <button
                      className="War-EndUserList_view-btn"
      ...
      <button className="War-EndUserList_add-btn" onClick={addNewUserRow}>
        Add New User
      </button>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <input
              ...
              onChange={(e) => handleInputChange(e, "new")}
            />
            <button className="War-EndUserList_save-btn" onClick={saveNewUser}>
              Save
            </button>
            <button
              className="War-EndUserList_cancel-btn"
...
export default EndUserList_Dashboard;
