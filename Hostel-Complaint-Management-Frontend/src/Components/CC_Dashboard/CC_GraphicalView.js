...
import "../RT_Dashboard/RT_Graph.css"; // Import your CSS file for styling
...
const RT_Graph_Dashboard = () => {
  ...
  const {name} = useParams(); // Extract hostel name from URL
  const hostel = name.replace(/-/g, " ").replace(/\b\w/g, (char) => char.toUpperCase());
  // Mock data
  ...
  return (
    <section className="CC_Graph RT_Graph">
      {/* Top Section: Cards */}
